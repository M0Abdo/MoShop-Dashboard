...
import '../../Controller/Screen/AddAdsController.dart';
...
class AddAds extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: GetBuilder<AddAdsController>(
                  ...
                  child: Stack(children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                         if(controller.file!=null) Image.file(
                          controller.file!,
                            height: 145,
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                       ...
                       ,child: Center(child: Text((controller.file==null)?"Add Image":"Change Image",style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 17),)),
                      ),
                    ),
                  ],
                ),
